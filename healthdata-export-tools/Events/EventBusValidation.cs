...
public static class EventBusValidation
{
    ...
    public static IReadOnlyList<string> Validate(this EventBus value)
    {
        ...
        // Validate that the EventBus is in a usable state
        // The handlers dictionary should never be null due to constructor initialization
    ...
    /// <exception cref="ArgumentNullException">Thrown if <paramref name="value"/> is null</exception>
    public static bool IsValid(this EventBus value) => value.Validate() is not null;
    ...
    /// <param name="value">The EventBus instance to validate</param>
    /// <exception cref="ArgumentNullException">Thrown if <paramref name="value"/> is null</exception>
    /// <exception cref="ArgumentException">Thrown if <paramref name="value"/> is invalid with problem details</exception>
