...
public static class DataComparisonServiceTestsExtensions
{
    ...
    public static HealthDataCollection WithSleepData(this HealthDataCollection collection, int sleepDurationMinutes, int deepSleepMinutes = 0)
    {
    ...
    public static HealthDataCollection WithHeartRateData(this HealthDataCollection collection, int averageBpm, int minBpm = 50, int maxBpm = 120)
    {
    ...
    public static HealthDataCollection WithStepsData(this HealthDataCollection collection, int totalSteps)
    {
    ...
    public static HealthDataCollection WithSpO2Data(this HealthDataCollection collection, int averagePercentage, int minPercentage = 90, int maxPercentage = 100)
    {
    ...
    public static HealthDataCollection WithActivityData(this HealthDataCollection collection, int durationMinutes, int caloriesBurned)
    {
